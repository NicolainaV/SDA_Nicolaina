...
public class Main {
    ...
    public static void main( String args[] ) {
		...
		/*
		definire tablou n x m 
		Nota: 
			Nu am gasit o metoda simpla de definire si folosire 'unsigned byte' in Java, 
			motiv pentru care m-am focalizat pe algoritmul de rezolvare a problemei 
			si nu pe untilizarea eficienta a memoriei si am definit tabloul ca 'int'
		*/
		int[][] tablou = new int[n][m];	// 'n' linii si 'm' coloane
		
		
		// initializare tablou cu valori 'random'
		for (int i=0; i<n; i++) {
			for (int j=0; j<m; j++) {
